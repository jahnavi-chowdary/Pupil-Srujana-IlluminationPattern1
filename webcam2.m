function out = webcam2
%WEBCAM2 Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, WEBCAM2.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, webcam2, at the MATLAB command prompt.
%   
%   The code file, WEBCAM2.M and its associated MAT-file, WEBCAM2.MAT (if
...
try
    MATvar = load('C:\Users\Dhruv Joshi\Documents\Srujana\Pupil-Tracking\webcam2');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\Dhruv Joshi\Documents\Srujana\Pupil-Tracking\webcam2.mat.
if (MATLoaded)
