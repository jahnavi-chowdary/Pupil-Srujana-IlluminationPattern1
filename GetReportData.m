function GetReportData(l_t,r_t,l,r,fname_plot)
...
per_change_left{1,1} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_left{1,1}) - (str2num(baseline_left{1,1})))/str2num(baseline_left{1,1}) * 100)))),'%');
constrict_time_left{1,1} = abs(time_left(1,start_l_1) - time_left_1(1,ind_minval));
recovery_time_left{1,1} = abs(time_left(1,last_l_1) - time_left_1(1,ind_minval));
...
per_change_left{1,2} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_left{1,2}) - (str2num(baseline_left{1,2})))/str2num(baseline_left{1,2}) * 100)))),'%');
constrict_time_left{1,2} =abs( time_left(1,start_l_2) - time_left_2(1,ind_minval));
recovery_time_left{1,2} = abs(time_left(1,last_l_2) - time_left_2(1,ind_minval));
...
per_change_left{1,3} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_left{1,3}) - (str2num(baseline_left{1,3})))/str2num(baseline_left{1,3}) * 100)))),'%');
constrict_time_left{1,3} =abs( time_left(1,start_l_3) - time_left_3(1,ind_minval));
recovery_time_left{1,3} = abs(time_left(1,last_l_3) - time_left_3(1,ind_minval));
...
per_change_left{1,4} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_left{1,4}) - (str2num(baseline_left{1,4})))/str2num(baseline_left{1,4}) * 100)))),'%');
constrict_time_left{1,4} =abs( time_left(1,start_l_4) - time_left_4(1,ind_minval));
recovery_time_left{1,4} = abs(time_left(1,last_l_4) - time_left_4(1,ind_minval));
...
per_change_right{1,1} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_right{1,1}) - (str2num(baseline_right{1,1})))/str2num(baseline_right{1,1}) * 100)))),'%');
constrict_time_right{1,1} =abs( time_right(1,start_r_1) - time_right_1(1,ind_minval));
recovery_time_right{1,1} = abs(time_right(1,last_r_1) - time_right_1(1,ind_minval));
...
per_change_right{1,2} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_right{1,2}) - (str2num(baseline_right{1,2})))/str2num(baseline_right{1,2}) * 100)))),'%');
constrict_time_right{1,2} =abs( time_right(1,start_r_2) - time_right_2(1,ind_minval));
recovery_time_right{1,2} = abs(time_right(1,last_r_2) - time_right_2(1,ind_minval));
...
per_change_right{1,3} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_right{1,3}) - (str2num(baseline_right{1,3})))/str2num(baseline_right{1,3}) * 100)))),'%');
constrict_time_right{1,3} =abs( time_right(1,start_r_3) - time_right_3(1,ind_minval));
recovery_time_right{1,3} = abs(time_right(1,last_r_3) - time_right_3(1,ind_minval));
...
per_change_right{1,4} = strcat(num2str(str2num(sprintf('%.2f',((str2num(min_value_right{1,4}) - (str2num(baseline_right{1,4})))/str2num(baseline_right{1,4}) * 100)))),'%');
constrict_time_right{1,4} =abs( time_right(1,start_r_4) - time_right_4(1,ind_minval));
recovery_time_right{1,4} = abs(time_right(1,last_r_4) - time_right_4(1,ind_minval));
...
os_data = [baseline_left;min_value_left;per_change_left;constrict_time_left;recovery_time_left];
